 ...
 *
 * Upload aceita: PDF, DWG, DXF, JPG, PNG, WebP — até 10 MB por arquivo, até 5 arquivos.
  ...
  function addFiles(newFiles: File[]) {
    ...
    for (const file of newFiles) {
      ...
      if (file.size > MAX_FILE_SIZE) {
        errorsList.push(`${file.name}: arquivo maior que 10 MB.`);
        continue;
      }
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-[0.72rem] text-muted-foreground">
                    PDF, DWG, DXF, JPG, PNG, WebP · até 10 MB por arquivo · máx. 5 arquivos
                  </p>
                </div>
